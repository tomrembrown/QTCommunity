...
const createEvent = async function (eventDetails) {
  ...
  let dataList = [eventDetails.event_group_id, eventDetails.place_id, eventDetails.start_time, eventDetails.end_time]
  ...
  let createPlaceQuery = 'INSERT INTO event_details (' + columnList.join(', ') + ') VALUES (' + parameters.join() + ');'
