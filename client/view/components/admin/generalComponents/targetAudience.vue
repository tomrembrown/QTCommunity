    ...
    <transition name="fade">
      <div v-if="!allGendersWelcome">
        <div class="row align-items-center">
          ...
          <div class="col-md-4">
            <ash-checkbox
              heading="Transgendered"
              idName="gender_transgendered"
            ></ash-checkbox>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-4">
            <ash-checkbox
              heading="Two-spirit"
              idName="gender_two_spirit"
            ></ash-checkbox>
          </div>
          <div class="col-md-4">
            <ash-checkbox
              heading="Male to Female Transexual"
              idName="gender_m2f_transexual"
            ></ash-checkbox>
          </div>
          <div class="col-md-4">
            <ash-checkbox
              heading="Female to Male Transexual"
              idName="gender_f2m_transexual"
            ></ash-checkbox>
          </div>
        </div>
      ...
      <div v-if="!allOrientationsWelcome">
        ...
        <div class="row align-items-center">
          <div class="col-md-4">
            <ash-checkbox
              heading="Queer"
              idName="orientation_queer"
            ></ash-checkbox>
          </div>
          <div class="col-md-4">
            <ash-checkbox
              heading="Questioning"
              idName="orientation_questioning"
            ></ash-checkbox>
          </div>
          <div class="col-md-4">
            <ash-checkbox
              heading="Asexual"
              idName="orientation_asexual"
            ></ash-checkbox>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-4">
            <ash-checkbox
              heading="Pansexual"
              idName="orientation_pansexual"
            ></ash-checkbox>
          </div>
          <div class="col-md-4">
            <ash-checkbox
              heading="Heterosexual"
              idName="orientation_heterosexual"
            ></ash-checkbox>
          </div>
        </div>
      </div>
