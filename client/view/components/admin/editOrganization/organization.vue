      ...
      <div class="col-md-12">
        <section>
          <label class="label" for="organization"
            >Organization Hosting the Event</label
          >
          <label class="select">
            <select
              id="organization"
    ...
    <transition name="fade">
      <div v-if="newOrganization">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <section>
              <label class="label" for="organizaton_description"
                >Description of Organization</label
              >
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-5">
            <ash-textbox
              heading="Twitter"
              helpText="Enter twitter handle for organization. Leave blank if none"
            >
            </ash-textbox>
          </div>
          <div class="col-md-1">
...
export default {
  ...
  methods: {
    onChangeOrganization(event) {
      if (event.target.value === 'New') this.newOrganization = true
      else this.newOrganization = false
    }
  },
  components: {
    'ash-textbox': Textbox,
